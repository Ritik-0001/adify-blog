...
// Dynamic import keeps Analytics out of the main page bundle and delays its
// event listeners until after the browser is idle — critical for INP.
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      >
        {/* lazyOnload = deferred until browser idle; avoids Clarity's event
            listeners hogging the main thread during early user interactions,
            which was the primary cause of 840ms INP. */}
        <Script
          id="clarity-script"
          strategy="lazyOnload"
